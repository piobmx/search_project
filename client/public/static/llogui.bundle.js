...
var LogUI = (function() {
    ...
    var h = e(function(e) {
        var t = (function(i) {
            ...
            return (
                (((c.prototype = S.constructor = u).constructor = c).displayName = a(
                    u,
                    r,
                    "GeneratorFunction"
                )),
                ...
                (i.mark = function(e) {
                    return (
                        Object.setPrototypeOf
                            ...
                            : ((e.__proto__ = u), a(e, r, "GeneratorFunction")),
    ...
    var i,
        ...
        d =
            ((i = window),
            ((t = {}).$ = i.document.querySelector.bind(i.document)),
            (t.$$ = i.document.querySelectorAll.bind(i.document)),
            (t.console = function(e) {
                ...
                if (
                    (t && (r = " (".concat(t, ")")),
                    n && (o = console.warn),
                    i.LogUI.Config.getConfigProperty("verbose") || n)
                ) {
                    var a =
                        new Date().getTime() -
                        i.LogUI.Config.getInitTimestamp();
                    if ("object" === s(e) && null !== e)
                        return (
                            o(
                                "LogUI"
                                    .concat(r, " @ ")
                                    .concat(a, "ms > Logged object below")
                            ),
                            void o(e)
                        );
                    o(
            ...
            t),
        m = { verbose: !0, overrideEqualSpecificity: !0, sessionUUID: null },
        v =
            ((r = [
                "console",
                "document",
    ...
    function te(e, t, n, r) {
        ...
        if (
            ...
            var g =
                "[" === e.hostname[0] &&
                "]" === e.hostname[e.hostname.length - 1];
            if (!g)
                for (
                    var y = e.hostname.split(/\./), b = 0, w = y.length;
                    b < w;
                    b++
                ) {
                    var E = y[b];
                    if (E && !E.match(B)) {
                        for (var S = "", A = 0, I = E.length; A < I; A++)
                            127 < E.charCodeAt(A) ? (S += "x") : (S += E[A]);
                        if (!S.match(B)) {
                            var x = y.slice(0, b),
                                O = y.slice(b + 1),
                                k = E.match(J);
                            k && (x.push(k[1]), O.unshift(k[2])),
                                O.length && (s = "/" + O.join(".") + s),
                                (e.hostname = x.join("."));
                            break;
                        }
            ...
            e.hostname.length > K
                ...
                g ||
                    (e.hostname = D(e.hostname, function(e) {
        ...
        if (!Y[u])
            for (b = 0, w = G.length; b < w; b++) {
                var j,
                    C = G[b];
                -1 !== s.indexOf(C) &&
                    ((j = encodeURIComponent(C)) === C && (j = escape(C)),
                    (s = s.split(C).join(j)));
            }
        var U = s.indexOf("#");
        ...
        return (
            -1 !== F
                ? ((e.search = s.substr(F)),
                  (e.query = s.substr(F + 1)),
                  n && (e.query = $(e.query)),
                  (s = s.slice(0, F)))
                : n && ((e.search = ""), (e.query = {})),
            s && (e.pathname = s),
            Q[u] && e.hostname && !e.pathname && (e.pathname = "/"),
            (e.pathname || e.search) &&
                ((h = e.pathname || ""),
                (P = e.search || ""),
                (e.path = h + P)),
                    ...
                    "object" == typeof n
                        ? q(z(n), function(e) {
                              ...
                              return F(n[e])
                                  ...
                                  : t + encodeURIComponent(M(n[e]));
                          }).join(r)
                        : a
                        ? encodeURIComponent(M(a)) +
                          o +
                          encodeURIComponent(M(n))
                        : ""));
        var f = e.search || (l && "?" + l) || "";
        return (
            i && ":" !== i.substr(-1) && (i += ":"),
    ...
    (V.prototype.parse = function(e, t, n) {
        ...
        (V.prototype.resolveObject = function(e) {
            ...
            for (
                var n, r, o = new V(), a = Object.keys(this), i = 0;
                i < a.length;
                i++
            ) {
                var s = a[i];
            ...
            if (e.protocol && e.protocol !== o.protocol) {
                ...
                if (((o.protocol = e.protocol), e.host || X[e.protocol]))
                    o.pathname = e.pathname;
                else {
                    for (
                        E = (e.pathname || "").split("/");
                        E.length && !(e.host = E.shift());
            ...
            var d,
                m = o.pathname && "/" === o.pathname.charAt(0),
            ...
            if (
                (w &&
                    ...
                    (o.port = null),
                    o.host &&
                        ("" === b[0] ? (b[0] = o.host) : b.unshift(o.host)),
                    (o.host = ""),
                    e.protocol &&
                        ((e.hostname = null),
                        (e.port = null),
                        e.host &&
                            ("" === E[0] ? (E[0] = e.host) : E.unshift(e.host)),
                        (e.host = null)),
                    (g = g && ("" === E[0] || "" === b[0]))),
                v)
            )
                ...
                return (
                    w &&
                        ...
                        (d =
                            !!(o.host && 0 < o.host.indexOf("@")) &&
                            o.host.split("@")) &&
                            ((o.auth = d.shift()),
                            (o.host = o.hostname = d.shift()))),
                    (o.search = e.search),
                    (o.query = e.query),
                    (U(o.pathname) && U(o.search)) ||
                        (o.path =
            ...
            return (
                w &&
                    ((o.hostname = o.host = !O && b.length ? b.shift() : ""),
                    (d =
                        !!(o.host && 0 < o.host.indexOf("@")) &&
                        o.host.split("@")) &&
                        ((o.auth = d.shift()),
                        (o.host = o.hostname = d.shift()))),
                (g = g || (o.host && b.length)) && !O && b.unshift(""),
                b.length
                    ? (o.pathname = b.join("/"))
    ...
    var oe = e(function(e, t) {
            ...
            (r.prototype.addError = function(e) {
                var t;
                if ("string" == typeof e)
                    t = new n(e, this.instance, this.schema, this.propertyPath);
                else {
    ...
    function ue(e, t, n, r, o) {
        ...
        return (
            (t.throwError = a),
            !i.valid && r instanceof Function && r(i),
            i.valid
        );
    }
    function le(e, t, n, r, o, a) {
        var i, s;
        this.types.object(e) &&
            ((t.properties && void 0 !== t.properties[o]) ||
                (!1 === t.additionalProperties
                    ...
                    : ((i = t.additionalProperties || {}),
                      ...
                      (s = this.validateSchema(e[o], i, n, r.makeChild(i, o)))
                          .instance !== a.instance[o] &&
                          (a.instance[o] = s.instance),
                      a.importErrors(s))));
    }
    (ce.type = function(e, t, n, r) {
        ...
        return (
            i.some(this.testType.bind(this, e, t, n, r)) ||
                ((o = i.map(function(e) {
                    return (e.id && "<" + e.id + ">") || e + "";
                })),
                a.addError({
        ...
        (ce.allOf = function(o, e, a, i) {
            ...
            var s = new ae(o, e, a, i),
                c = this;
            return (
                e.allOf.forEach(function(e, t) {
                    var n,
                        r = c.validateSchema(o, e, a, i);
                    r.valid ||
                        ((n =
                            (e.id && "<" + e.id + ">") ||
                            (e.title && JSON.stringify(e.title)) ||
        ...
        (ce.oneOf = function(e, t, n, r) {
            ...
            return (
                1 !== i &&
                    (n.nestedErrors && o.importErrors(a),
                    o.addError({
                        name: "oneOf",
                        argument: s,
        ...
        (ce.properties = function(e, t, n, r) {
            if (this.types.object(e)) {
                ...
                for (o in i) {
                    "function" == typeof n.preValidateProperty &&
                        n.preValidateProperty(e, o, i[o], n, r);
                    var s = Object.hasOwnProperty.call(e, o) ? e[o] : void 0,
                        c = this.validateSchema(
                            s,
                            i[o],
                            n,
                            r.makeChild(i[o], o)
                        );
                    c.instance !== a.instance[o] &&
                        (a.instance[o] = c.instance),
                        a.importErrors(c);
                }
                return a;
            }
                ...
                for (o in e) {
                    ...
                    for (s in i) {
                        new RegExp(s).test(o) &&
                            ((u = !1),
                            "function" == typeof n.preValidateProperty &&
                                n.preValidateProperty(e, o, i[s], n, r),
                            (c = this.validateSchema(
                                e[o],
                                i[s],
                                n,
            ...
            if (this.types.array(e) && o.items) {
                ...
                return (
                    e.every(function(e, t) {
                        ...
                        return (
                            r.instance !== c.instance[t] &&
                                (c.instance[t] = r.instance),
                            c.importErrors(r),
                            !0
                        );
                    }),
                ...
                return (
                    (t.exclusiveMinimum && !0 === t.exclusiveMinimum
                        ...
                        o.addError({
                            ...
                            argument: t.minimum,
                            message:
                                "must have a minimum value of " + t.minimum,
                        }),
                    o
                );
            }
                ...
                return (
                    a ||
                        o.addError({
                            ...
                            argument: t.maximum,
                            message:
                                "must have a maximum value of " + t.maximum,
                        }),
                    o
                );
            }
    ...
    function fe(e, t, n, r, o, a) {
        if (this.types.number(e)) {
            ...
            var s = new ae(e, t, n, r),
                ...
                f = Math.pow(10, l);
            return (
                Math.round(e * f) % Math.round(i * f) != 0 &&
                    s.addError({
                        name: o,
                        argument: i,
    ...
    (ce.multipleOf = function(e, t, n, r) {
                      ...
                      e.required.forEach(function(e) {
                          void 0 === t[e] &&
                              o.addError({
                                  ...
                                  argument: e,
                                  message:
                                      "requires property " + JSON.stringify(e),
                              });
                      }),
                o
            );
                ...
                return (
                    e.length >= t.minItems ||
                        o.addError({
                            ...
                            argument: t.minItems,
                            message:
                                "does not meet minimum length of " + t.minItems,
                        }),
                    o
                );
            }
                ...
                return (
                    e.length <= t.maxItems ||
                        o.addError({
                            ...
                            argument: t.maxItems,
                            message:
                                "does not meet maximum length of " + t.maxItems,
                        }),
                    o
                );
            }
        ...
        (ce.enum = function(e, t, n, r) {
            ...
            if (!Array.isArray(t.enum))
                throw new ie("enum expects an array", t);
            var o = new ae(e, t, n, r);
            return (
                t.enum.some(oe.deepCompareStrict.bind(null, e)) ||
                    o.addError({
                        name: "enum",
                        argument: t.enum,
                        message:
                            "is not one of enum values: " +
                            t.enum.map(String).join(","),
                    }),
                o
            );
        }),
        (ce.const = function(e, t, n, r) {
            ...
            var o = new ae(e, t, n, r);
            return (
                oe.deepCompareStrict(t.const, e) ||
                    o.addError({
                        name: "const",
                        argument: t.const,
                        message:
                            "does not exactly match expected constant: " +
                            t.const,
                    }),
                o
            );
    ...
    function me() {
        (this.customFormats = Object.create(me.prototype.customFormats)),
            (this.schemas = {}),
            (this.unresolvedRefs = []),
            (this.types = Object.create(Se)),
            (this.attributes = Object.create(pe.validators));
    }
    var ve = {
            SchemaScanResult: de,
            scan: function(e, t) {
                function o(e, t) {
                    if (t && "object" == typeof t)
                        if (t.$ref) {
                            ...
                            a(
                                r + "/items",
                                Array.isArray(t.items) ? t.items : [t.items]
                            ),
                                a(
                                    r + "/extends",
                                ...
                                o(r + "/additionalItems", t.additionalItems),
                                i(r + "/properties", t.properties),
                                o(
                                    r + "/additionalProperties",
                                    t.additionalProperties
                                ),
                                i(r + "/definitions", t.definitions),
                                i(
                                    r + "/patternProperties",
                                    t.patternProperties
                                ),
                                i(r + "/dependencies", t.dependencies),
                                a(r + "/disallow", t.disallow),
                                a(r + "/allOf", t.allOf),
                                a(r + "/anyOf", t.anyOf),
                                a(r + "/oneOf", t.oneOf),
                                o(r + "/not", t.not);
    ...
    (me.prototype.customFormats = {}),
        (me.prototype.schemas = null),
        (me.prototype.types = null),
        (me.prototype.attributes = null),
        (me.prototype.unresolvedRefs = null),
        (me.prototype.addSchema = function(e, t) {
            var n = this;
            if (!e) return null;
            var r,
                o = ge(t || "/", e),
        ...
        (me.prototype.validate = function(e, t, n, r) {
            ...
            if (!r) {
                (r = new we(t, n, o, a, Object.create(this.schemas))).schemas[
                    a
                ] || (r.schemas[a] = t);
                var i,
                    s = ge(a, t);
        ...
        (me.prototype.validateSchema = function(e, t, n, r) {
            ...
            if (
                (t.extends &&
                    (Array.isArray(t.extends)
                        ? ((o = { schema: t, ctx: r }),
                          t.extends.forEach(this.schemaTraverser.bind(this, o)),
                          (t = o.schema),
                          (o.schema = null),
                          (o.ctx = null),
                          (o = null))
            ...
            for (u in t)
                if (!pe.ignoreProperties[u] && f.indexOf(u) < 0) {
                    ...
                    if (p) h = p.call(this, e, t, n, r);
                        ...
                        throw new be("Unsupported attribute: " + u, t);
                    h && i.importErrors(h);
                }
            return (
                "function" == typeof n.rewrite &&
                    ((l = n.rewrite.call(this, e, t, n, r)), (i.instance = l)),
                i
            );
        }),
        ...
        (me.prototype.resolve = function(e, t, n) {
            ...
            if (!a || !n.schemas[a])
                throw new be("no such schema <" + t + ">", e);
            var i = oe.objectGetPath(n.schemas[a], o.substr(1));
            if (void 0 === i)
                throw new be(
                    "no such schema " + o + " located in <" + a + ">",
                    e
                );
    ...
    var Ae = me,
        Ie = e(function(e) {
            ...
            (e.exports.ValidatorResult = oe.ValidatorResult),
                (e.exports.ValidationError = oe.ValidationError),
                (e.exports.SchemaError = oe.SchemaError),
                (e.exports.SchemaScanResult = ve.SchemaScanResult),
                (e.exports.scan = ve.scan),
        ...
        Ce = {
            ...
            validateSuppliedConfigObject: function(e) {
                var t = new xe();
                return (
                    t.addSchema(ke, "/LogUI-logUIConfig"),
                    t.addSchema(je, "/LogUI-trackingConfig"),
                    t.addSchema(Le, "/LogUI-browserEvents"),
                    t.validate(e, Oe)
                );
            },
        };
    ...
    var Fe = "logUI-sessionIDKey",
        Te = (function(r) {
            ...
            var f = function(e) {
                return (
                    d.extendObject(s, m.dispatcher),
                    d.extendObject(s, e.logUIConfiguration),
                    (t = e.applicationSpecificData),
                    (i = e.trackingConfiguration),
                    (c = e.logUIConfiguration.browserEvents),
                    !0
                );
            };
            (n.reset = function() {
                    ...
                    removeRule: function(e, t) {
                        if (l) {
                            for (var n in l.sheet.cssRules) {
                                if (
                                    l.sheet.cssRules[n].cssText ==
                                    "".concat(e, " { ").concat(t, " }")
                                )
                                    return l.sheet.removeRule(n), !0;
                            }
                            return !1;
                        }
                    },
                ...
                (n.sessionData = {
                    ...
                    setTimestamps: function(e, t) {
                        (a.sessionStartTimestamp = e),
                            (a.libraryStartTimestamp = t);
                    },
            ...
            var h = function() {
                    ...
                    try {
                        for (t.s(); !(e = t.n()).done; ) {
                            var n = e.value;
                            if (!d.getElementDescendant(r, n))
                                return (
                                    d.console(
                                        "The required feature '".concat(
                                            n,
                                            "' cannot be found; LogUI cannot start!"
                                        ),
                                        "Initialisation",
                                        !0
                                    ),
                ...
                p = function(e) {
                    ...
                    if (t.valid) return !0;
                    d.console(
                        "The configuration object passed to LogUI was not valid or complete; refer to the warning(s) below for more information.",
                        "Initialisation",
                        !0
                    );
                    var n,
    ...
    (m.dispatcher = {
        ...
        v.addFeature("WebSocket"),
        Ce.addLogUIConfigProperty("endpoint", "string"),
        Ce.addLogUIConfigProperty("authorisationToken", "string");
    ...
    var De = (function(n) {
        var e = {},
            ...
            i = null,
            s = null;
        (e.dispatcherType = "websocket"),
            (e.init = function() {
                return (
                    Te.getConfigProperty("endpoint"),
            ...
            (e.sendObject = function(e) {
                ...
                // // console.log("INSIDE LOGUI:", process.enEACT_APP_SERVER_URL)
                const fullUrl = document.URL;
                e.fullUrl = fullUrl;
                // e.QID = localStorage.getItem("qid")
                
                e.QID = window.sharedVariable
                ...
                fetch(urlEncoded, requestBody)
                    .then((response) => {
                        // console.log("logui res:", response)
                        //response.json()
                    })
                    .then((data) => {
                        // console.log("logui data logged", data)
                    })
                    .catch((error) => {
                        if (error.name === "AbortError") {
                            console.log("Fetch request timed out");
                        } else {
                            console.error("logui error:", error);
                        }
                    });

                // console.log("sending bundle data", data);
                ...
                //	console.error('xhttp Request timed out');
                //}
                ...
                //	} else {
                //		console.error(`XHTTP Request failed with status: ${xhttp.status}`);
                //	}
                //}

                //        xhttp.open(
                //            "POST",
                //            process.env.REACT_APP_SERVER_URL + "/v1/insert_single_logui_data",
                //            true
                //        );
                ...
                if (r)
                    return (
                        s.push(e),
                        d.console(e, "Dispatcher", !1),
                        void (s.length >= m.dispatcher.cacheSize && f())
                    );
                throw Error(
                    "You cannot send a message when LogUI is not active.2"
                );
            });
        ...
        var c = function() {
                (o = new WebSocket(
                    Te.getConfigProperty("endpoint")
                )).addEventListener("close", t.onClose),
                    o.addEventListener("error", t.onError),
                    o.addEventListener("message", t.onMessage),
                    o.addEventListener("open", t.onOpen);
            },
            u = function() {
                o &&
                    (d.console(
                        "The connection to the server is being closed.",
                        "Dispatcher",
                        !1
                    ),
                    o.removeEventListener("close", t.onClose),
                    o.removeEventListener("error", t.onError),
                    o.removeEventListener("message", t.onMessage),
                    o.removeEventListener("open", t.onOpen),
                    o.close(),
                    (o = null));
            },
            t = {
                onClose: function(e) {
                    ...
                    var t =
                        "Something went wrong with the connection to the LogUI server.";
                    switch (e.code) {
                        case 4001:
                            t =
                                "A bad message was sent to the LogUI server. LogUI is shutting down.";
                            break;
                        case 4002:
                            t =
                                "The client sent a bad application handshake to the server. LogUI is shutting down.";
                            break;
                        case 4003:
                            t =
                                "The LogUI server being connected to does not support version 0.5.3e of the client. LogUI is shutting down.";
                            break;
                        case 4004:
                            t =
                                "A bad authentication token was provided to the LogUI server. LogUI is shutting down.";
                            break;
                        case 4005:
                            t =
                                "The LogUI server did not recognise the domain that this client is being started from. LogUI is shutting down.";
                            break;
                        case 4006:
                            (t =
                                "The LogUI client sent an invalid session ID to the server. LogUI is shutting down."),
                                Te.sessionData.clearSessionIDKey();
                            break;
                        case 4007:
                            t =
                                "The LogUI server is not accepting new connections for this application at present.";
                            break;
                        default:
                            t = ""
                                .concat(t, " The recorded error code was ")
                                .concat(e.code, ". LogUI is shutting down.");
                    }
                    switch (e.code) {
                        case 1e3:
                        ...
                        case 1006:
                            o &&
                                ...
                                (i = setInterval(function() {
                                    if (r) {
                                        if (o)
                                            switch (o.readyState) {
                                                ...
                                                default:
                                                    return (
                                                        d.console(
                                                            "The connection to the server has failed; we are unable to restart.",
                                                            "Dispatcher",
                                                            !0
                                                        ),
                                                        void u()
                                        ...
                                        if (
                                            (a += 1) ==
                                            m.dispatcher.reconnectAttempts
                                        )
                                            throw (d.console(
                                                "We've maxed out the number of permissible reconnection attempts. We must stop here.",
                                                "Dispatcher",
                                                !0
                                            ),
                                            clearInterval(i),
                                            n.dispatchEvent(
                                                new Event(
                                                    "logUIShutdownRequest"
                                                )
                                            ),
                                            Error(
                                                "LogUI attempted to reconnect to the server but failed to do so. LogUI is now stopping. Any events not sent to the server will be lost."
                                            ));
                                        d.console(
                            ...
                            break;
                        default:
                            throw (n.dispatchEvent(
                                new Event("logUIShutdownRequest")
                            ),
                            Error(t));
                    }
                },
                ...
                onMessage: function(e) {
                    ...
                    "handshakeSuccess" === t.type &&
                        (d.console(
                            "The handshake was successful. Hurray! The server is listening.",
                            "Dispatcher",
                            !1
                        ),
                        Te.sessionData.setID(t.payload.sessionID),
                        t.payload.newSessionCreated
                            ? Te.sessionData.setTimestamps(
                                  new Date(t.payload.clientStartTimestamp),
                                  new Date(t.payload.clientStartTimestamp)
                              )
                            : (Te.sessionData.setTimestamps(
                                  new Date(t.payload.clientStartTimestamp),
                              ...
                              s.length >= m.dispatcher.cacheSize && f()),
                        n.dispatchEvent(new Event("logUIStarted")));
                },
                onOpen: function() {
                    ...
                    var t = {
                        ...
                        authorisationToken: Te.getConfigProperty(
                            "authorisationToken"
                        ),
                    ...
                    e && (t.sessionID = Te.sessionData.getSessionIDKey()),
                        d.console(
                            "The LogUI handshake has been sent.",
                            "Dispatcher",
                            !1
                        ),
                        o.send(JSON.stringify(l("handshake", t)));
                },
            },
            l = function(e, t) {
            ...
            f = function() {
                var e;
                o && 1 == o.readyState
                    ? ((e = { length: s.length, items: s }),
                      o.send(JSON.stringify(l("logEvents", e))),
                      d.console("Cache flushed.", "Dispatcher", !1),
                      (s = []))
                    : s.length >= m.dispatcher.maximumCacheSize &&
                      (d.console(
                          "The cache has grown too large, with no connection to clear it. LogUI will now stop; any cached events will be lost.",
                          "Dispatcher",
                          !1
                      ),
                      n.dispatchEvent(new Event("logUIShutdownRequest")));
            };
        return e;
    })(window);
    function _e(e, t) {
    ...
    var Me,
                ...
                n = {
                    ...
                    deleteEventsWithGroup: function(e) {
                        for (var t in n.events)
                            n.getEventGroupName(t) == e && n.deleteEvent(t);
                    },
        ...
        Ge = (Me = {
            ...
            getValue: function(e, t) {
                if (t.hasOwnProperty("lookFor") && e.hasAttribute(t.lookFor))
                    return e.getAttribute(t.lookFor);
            },
        }),
        We = Object.freeze({ __proto__: null, default: Ge }),
        He = (qe = {
            init: function() {},
            stop: function() {},
            getObject: function(e, t) {
            ...
            getValue: function(e, t) {
                if (t.hasOwnProperty("lookFor") && e[t.lookFor])
                    return e[t.lookFor];
            },
        }),
        Ke = Object.freeze({ __proto__: null, default: He }),
        Be = (ze = {
            init: function() {},
            stop: function() {},
            getObject: function(e, t) {
            ...
            getValue: function(e, t) {
                if (t.hasOwnProperty("lookFor"))
                    return localStorage.getItem(t.lookFor);
            },
        }),
        Je = Object.freeze({ __proto__: null, default: Be }),
        Ye = ($e = {
            init: function() {},
            stop: function() {},
            getObject: function(e, t) {
        ...
        et = Object.freeze({ __proto__: null, default: Qe }),
        tt = (Ne = {
            init: function() {},
            stop: function() {},
            getObject: function(e, t) {
            ...
            getValue: function(e, t) {
                if (t.hasOwnProperty("lookFor"))
                    return sessionStorage.getItem(t.lookFor);
            },
        }),
        ...
        mt =
            ((ht = {
                ...
                getMetadataValue: function(e, t) {
                    ...
                    if (
                        n &&
                        t.hasOwnProperty("nameForLog") &&
                        t.hasOwnProperty("lookFor")
                    )
                    ...
                    if (t.hasOwnProperty("metadata")) {
                        ...
                        try {
                            for (a.s(); !(o = a.n()).done; ) {
                                ...
                                r.includes(i.nameForLog) ||
                                    (s && (n.push(s), r.push(i.nameForLog)));
                            }
                        } catch (e) {
                            a.e(e);
                        } finally {
            ...
            ((yt = {
                ...
                logUIEventCallback: function(e, t, n) {
                    ...
                    return (
                        console.log(r),
                        r && (a.name = r),
                        0 < o.length && (a.submissionValues = o),
                        a
                    );
                },
            }),
                    ...
                    try {
                        for (a.s(); !(o = a.n()).done; ) {
                            var i,
                                ...
                                c = d.$(s.selector);
                            c &&
                                (i = mt.getMetadataValue(c, s)) &&
                                (r.includes(s.nameForLog) ||
                                    (r.push(s.nameForLog), n.push(i)));
                        }
                    } catch (e) {
                        a.e(e);
                    } finally {
    ...
    var St,
        ...
        It = (function() {
            var e = {},
                s = null;
            (e.browserEvents = ["mousedown", "mouseup"]),
                (e.init = function() {
                    s = new WeakMap();
                }),
                (e.stop = function() {
                ...
                (e.logUIEventCallback = function(e, t, n) {
                    if (
                        ("mousedown" == t.type && s.set(e, t.timeStamp),
                        "mouseup" == t.type && s.has(e))
                    ) {
            ...
            var c = function(e, t) {
                if (e.properties) {
                    ...
                    if (t in n && e.properties[n[t]])
                        return (
                            (e.properties[n[t]].mapping = n[t]),
                            e.properties[n[t]]
                        );
                }
            };
        ...
        xt = Object.freeze({ __proto__: null, default: It }),
        Ot =
            ((St = {
            ...
            (At = function(e, t) {
                var n = e.properties;
                if (n && n.hasOwnProperty(t) && n[t].hasOwnProperty("name"))
                    return n[t].name;
            }),
            St),
        kt = Object.freeze({ __proto__: null, default: Ot });
    ...
    var Lt,
        ...
        Ut = Object.freeze({ __proto__: null, default: Ct }),
        Pt =
            ((Lt = {
                init: function() {
                    return !0;
                ...
                packageInteractionEvent: function(e, t, n) {
                    var r = jt();
                    (r.eventType = "interactionEvent"),
                        (r.eventDetails = t),
                        (r.metadata = mt.getMetadata(e, n)),
                        De.sendObject(r);
                },

                packageCustomEvent: function(e) {
                    var t = jt();
                    (t.eventType = "customEvent"),
                        (t.eventDetails = e),
                        De.sendObject(t);
                },
                ...
                packageBrowserEvent: function(e) {
                    var t = jt();
                    (t.eventType = "browserEvent"),
                        (t.eventDetails = e),
                        De.sendObject(t);
                },
                packageStatusEvent: function(e) {
                    var t = jt();
                    (t.eventType = "statusEvent"),
                        (t.eventDetails = e),
                        De.sendObject(t);
                },
            }),
    ...
    var Dt,
        ...
        zt = (function() {
            ...
            var h = function(e, t) {
                    var n, r, o, a;
                    l.has(e) &&
                        ((r = (n = l.get(e)).handles.indexOf(t)),
                        n.handles.splice(r, 1),
                        (r = f.indexOf(t)),
                        f.splice(r, 1),
                        0 == n.handles.length &&
                            (l.delete(e),
                            (o = { type: "scrollEnd" }),
                            (a = p(n.trackingConfig, "scrollEnd")) &&
                                (o.name = a),
                            Pt.packageInteractionEvent(
                                e,
                                o,
                                n.trackingConfig
                            )));
        ...
        $t = Object.freeze({ __proto__: null, default: zt }),
        Vt = {};
    ...
    function Nt(c) {
        ...
        function t(e) {
            var t, n, r, o;
            if (e.test(u))
                for (n = 0, r = (t = u.match(e)).length; n < r; n += 1)
                    (o = t[n]),
                        (u = u.replace(o, Array(o.length + 1).join("A")));
        }
        return (
            (e = function(e, t) {
                var n, r, o, a, i, s;
                if (e.test(u))
                    for (r = 0, o = (n = u.match(e)).length; r < o; r += 1)
                        (l[t] += 1),
                            (a = n[r]),
                            (i = u.indexOf(a)),
                            (s = a.length),
            ...
            (function() {
                var e,
                    ...
                    o = /{[^]*/gm;
                if (o.test(u))
                    for (t = 0, n = (e = u.match(o)).length; t < n; t += 1)
                        (r = e[t]),
                            (u = u.replace(r, Array(r.length + 1).join(" ")));
            })(),
            e(/(\[[^\]]+\])/g, "b"),
            e(/(#[^\#\s\+>~\.\[:\)]+)/g, "a"),
            e(/(\.[^\s\+>~\.\[:\)]+)/g, "b"),
            ...
            (u = (u = (u = (u = (u = (u = u.replace(
                /[\*\s\+>~]/g,
                " "
            )).replace(/[#\.]/g, " ")).replace(/:not/g, "    ")).replace(
                /:local/g,
                "      "
            )).replace(/:global/g, "       ")).replace(/[\(\)]/g, " ")),
            e(/([^\s\+>~\.\[:]+)/g, "c"),
            f.sort(function(e, t) {
    ...
    var Gt,
        ...
        Ht =
            (((Gt = {
                init: function() {
                    for (var e in Wt)
                        Wt[e].hasOwnProperty("init") && Wt[e].init();
                    return !0;
                },
                stop: function() {
                    for (var e in Wt)
                        Wt[e].hasOwnProperty("stop") && Wt[e].stop();
                },
            }).eventHandlers = Wt),
            (Gt.getEventHandler = function(e) {
                return !!Wt.hasOwnProperty(e) && Wt[e];
            }),
            (Gt.getEventHandlerEvents = function(e) {
                if (Wt.hasOwnProperty(e))
                    return Wt[e].hasOwnProperty("browserEvents")
                        ? Wt[e].browserEvents
                        : (d.console(
                              "The event handler '".concat(
                                  e,
                                  "' does not have the required property 'browserEvents'."
                              ),
                              "Initialisation",
                              !0
                          ),
                ...
                trackingConfig: h.mark(function() {
                    ...
                    return h.wrap(function(e) {
                        for (;;)
                            switch ((e.prev = e.next)) {
                                case 0:
                                    (t = Te.elementTrackingConfig.get()),
                                        (e.t0 = h.keys(t));
                                case 2:
                                    if ((e.t1 = e.t0()).done) {
                                        e.next = 12;
                        ...
                        for (o.s(); !(n = o.n()).done; ) {
                            ...
                            if (r.hasEvent(a)) {
                                var i = r.getEventGroupName(a),
                                    s = Te.elementTrackingConfig.getElementGroup(
                                        i
                                    ).selector;
                                if (i == t.name) continue;
                                var c = -1 == Zt(s, t.selector);
                                Te.getConfigProperty(
                                    "overrideEqualSpecificity"
                                ) && (c = Zt(s, t.selector) <= 0),
                                    c &&
                                        (r.deleteEventsWithGroup(i),
                                        r.setEvent(a, t.name));
            ...
            ((Yt = {
                logUIEventCallback: function(e) {
                    var t,
                        ...
                        r,
                        o,
                        a = Te.DOMProperties.get(e.target);
                    2 == e.eventPhase &&
                        a &&
                        ((t = a.getEventGroupName(e.type)),
                        (n = Te.elementTrackingConfig.getElementGroup(t)),
                        (o = !1),
                        (o = (r = Ht.getEventHandler(n.event))
                            ? r.logUIEventCallback(this, e, n)
                            : Xt(this, e, n)) &&
                            Pt.packageInteractionEvent(this, o, n));
                },
            }),
            (Xt = function(e, t, n) {
                var r = { type: t.type };
    ...
    var rn,
        ...
        gn = (rn = {
            init: function() {
                var e,
                    t = tn(Qt.generators.uniqueElements());
                try {
                    for (t.s(); !(e = t.n()).done; ) {
                        var n = e.value;
                        rn.bind(n);
            ...
            bind: function(e) {
                var t,
                    n = tn(Te.DOMProperties.get(e).getEventList());
                try {
                    for (n.s(); !(t = n.n()).done; ) {
                        var r = t.value;
        ...
        yn =
            ...
            (an = {
                init: function() {
                    Te.browserEventsConfig.get("contextMenu", !0) &&
                        on.document.addEventListener("contextmenu", sn);
                },
                stop: function() {
            ...
            an),
        bn = Object.freeze({ __proto__: null, default: yn }),
        wn = (function(t) {
            var e = {},
                n = null,
                r = 200,
            ...
            (e.init = function() {
                var e;
                Te.browserEventsConfig.get("trackCursor", !0) &&
                    ((e = Te.browserEventsConfig.get(
                        "cursorUpdateFrequency",
                        200
                    )),
                    (r = !(e <= 0) && e),
                    (n = Te.browserEventsConfig.get("cursorLeavingPage", !0)),
                    t.document.addEventListener("mousemove", u),
                    n &&
                        (t.document.addEventListener("mouseleave", p),
                        t.document.addEventListener("mouseenter", d)),
                    l());
            }),
                (e.stop = function() {
                    t.document.removeEventListener("mousemove", u),
                        t.document.removeEventListener("mouseleave", p),
                        t.document.removeEventListener("mouseenter", d),
                        f(),
                        (r = 200),
                        (i = a = n = null);
                });
            ...
            var u = function(e) {
                    r || h(e, t.document.hasFocus()),
                        (a = e),
                        (i = t.document.hasFocus());
                },
                l = function() {
                ...
                h = function(e, t) {
                    var n = c(e, t);
                    (n.type = "cursorTracking"),
                        (n.trackingType = "positionUpdate"),
                        Pt.packageBrowserEvent(n);
                },
                p = function(e) {
                    var t = c(e, i);
                    (t.type = "cursorTracking"),
                        (t.trackingType = "cursorLeftViewport"),
                        f(),
                        Pt.packageBrowserEvent(t);
                },
                d = function(e) {
                    var t = c(e, i);
                    (t.type = "cursorTracking"),
                        (t.trackingType = "cursorEnteredViewport"),
                        l(),
                        Pt.packageBrowserEvent(t);
                };
            return e;
        })(window),
        En = Object.freeze({ __proto__: null, default: wn }),
        Sn =
            ((cn = window),
            (un = {
                init: function() {
                    Te.browserEventsConfig.get("pageFocus", !0) &&
                        (cn.addEventListener("blur", ln),
                        cn.addEventListener("focus", ln));
                },
                stop: function() {
                    cn.removeEventListener("blur", ln),
                        cn.removeEventListener("focus", ln);
                },
            }),
            (ln = function(e) {
                var t = "focus" === e.type;
            ...
            un),
        An = Object.freeze({ __proto__: null, default: Sn }),
        In = (function(e) {
            var t = {};
            (t.init = function() {
                Te.browserEventsConfig.get("eventsWhileScrolling", !0) &&
                    (Te.CSSRules.addRule(
            ...
            var n = function() {
                setTimeout(function() {
                    ...
                    e.document.body.classList.contains("disable-hover") ||
                        e.document.body.classList.add("disable-hover");
            };
            return t;
        })(window),
        xn = Object.freeze({ __proto__: null, default: In }),
        On = (function(n) {
            var e = {},
                r = n.location.href;
            (e.init = function() {
                Te.browserEventsConfig.get("URLChanges", !0) &&
                    n.addEventListener("popstate", t);
            }),
                (e.stop = function() {
        ...
        kn = Object.freeze({ __proto__: null, default: On }),
        Ln = (function(e) {
            var t = {},
                n = null;
            (t.init = function() {
                Te.browserEventsConfig.get("pageResize", !0) &&
                ...
                clearTimeout(n),
                    (n = setTimeout(function() {
                        Pt.packageBrowserEvent({
                            ...
                            stringRepr: ""
                                .concat(e.target.innerWidth, "x")
                                .concat(e.target.innerHeight),
                        });
                    }, 200));
            };
            return t;
        })(window),
        jn = Object.freeze({ __proto__: null, default: Ln }),
        Cn = {};
        ...
        var r = function(e) {
            ...
            c = function(e) {
                ...
                try {
                    for (r.s(); !(t = r.n()).done; ) {
                        var o = t.value;
                        e.matches(o.selector) &&
                            ((n = !0), Qt.processElement(e, o));
                    }
                } catch (e) {
                    r.e(e);
                } finally {
    ...
    var Mn,
        ...
        Zn =
            ...
            (qn = function() {
                var e,
                    t = _n(Qt.generators.trackingConfig());
                try {
                    for (t.s(); !(e = t.n()).done; ) {
                        var n,
                            r = e.value;
    ...
    return (
        ...
        ((Nn = {
            ...
            buildDate:
                "Wed May 05 2021 22:06:25 GMT+0100 (British Summer Time)",
        }).Config = Te),
        (Nn.init = (function() {
            var t = p(
                h.mark(function e(t) {
                        ...
                        for (;;)
                            switch ((e.prev = e.next)) {
                                case 0:
                                    ...
                                    throw Error(
                                        "LogUI requires a configuration object to be passed to the init() function."
                                    );
                                case 3:
                                    if (Te.init(t)) {
                                        e.next = 5;
                                    ...
                                    throw Error(
                                        "The LogUI configuration component failed to initialise. Check console warnings to see what went wrong."
                                    );
                                case 5:
                                    if (mt.init()) {
                                        e.next = 7;
                                    ...
                                    throw Error(
                                        "The LogUI metadata handler component failed to initialise. Check console warnings to see what went wrong."
                                    );
                                case 7:
                                    if (Pt.init()) {
                                        e.next = 9;
                                    ...
                                    throw Error(
                                        "The LogUI event packaging component failed to initialise. Check console warnings to see what went wrong."
                                    );
                                case 9:
                                    if (Gn.init()) {
                                        e.next = 11;
                                    ...
                                    throw Error(
                                        "The LogUI events component failed to initialise. Check console warnings to see what went wrong."
                                    );
                                case 11:
                                ...
                                case 13:
                                    ...
                                    throw Error(
                                        "The LogUI dispatcher component failed to initialise. Check console warnings to see what went wrong."
                                    );
                                case 15:
                                    if (Zn.init()) {
                                        e.next = 17;
                                    ...
                                    throw Error(
                                        "The LogUI DOMHandler component failed to initialise. Check console warnings to see what went wrong."
                                    );
                                case 17:
                                    if (Ht.init()) {
                                        e.next = 19;
                                    ...
                                    throw Error(
                                        "The LogUI event handler controller component failed to initialise. Check console warnings to see what went wrong."
                                    );
                                case 19:
                    ...
                    for (;;)
                        switch ((e.prev = e.next)) {
                            case 0:
                                ...
                                throw Error(
                                    "LogUI may only be stopped if it is currently running."
                                );
                            case 2:
                                return (
                                    Vn.removeEventListener("unload", Nn.stop),
                            ...
                            case 11:
                                Te.reset(),
                                    Vn.dispatchEvent(new Event("logUIStopped"));
                            case 13:
                            case "end":
                                return e.stop();
                        }
        ...
        (Nn.logCustomMessage = function(e) {
            if (!Nn.isActive())
                throw Error(
                    "Custom messages may only be logged when the LogUI client is active."
                );
        ...
        (Nn.updateApplicationSpecificData = function(e) {
            if (!Nn.isActive())
                throw Error(
                    "Application specific data can only be updated when the LogUI client is active."
                );
            Te.applicationSpecificData.update(e),
                Gn.logUIUpdatedApplicationSpecificData();
        }),
        (Nn.deleteApplicationSpecificDataKey = function(e) {
            Te.applicationSpecificData.deleteKey(e),
                Gn.logUIUpdatedApplicationSpecificData();
        }),
        (Nn.clearSessionID = function() {
            if (Nn.isActive())
                throw Error(
                    "The session ID can only be reset when the LogUI client is inactive."
                );
            Te.sessionData.clearSessionIDKey();
        }),
        Nn
    ...
    if (window.LogUI) {
        ...
        let configurationObject = {
            logUIConfiguration: {
                ...
                endpoint: "wss://logui.ewi.tudelft.nl/ws/endpoint/",
                authorisationToken:
